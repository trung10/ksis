...
`
--> E hèm, ừa khá đúng Trung có rất nhiều ước mong. Và đang từng bước thực hiện. Nhưng mà nếu không có ước mong đó thì Trung đâu có vừa học vừa làm full time cho một công ty outsource của Nhật từ cuối năm 4. Ngẩm lại thì Trung nhiều khi cực đoan trong một số vấn đề. Ví dụ như thực 3 ngày 3 đêm để làm đồ án mà rất ít ăn. Hay chạy xe quá nhanh để có được cảm giác phấn khích.
`
...
`
--> Giống quá rồi còn gì. "Tại sao" trong vấn đề nào đó tức là mình còn tò mó về nó, còn muốn tìm hiểu và biết thêm. Anh Dương Ngọc Thái (kỹ sư google) từng định nghĩa "còn đam mê là còn tò mò".
`
...
`
--> Cái này không đúng rồi. Trung chỉ nhức đầu khi code thôi nhé.
`
